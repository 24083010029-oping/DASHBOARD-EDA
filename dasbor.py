...
# UPLOAD DATA
# ==============================
uploaded_file = st.file_uploader("data lastminute bersih.csv")
...
if uploaded_file:
    ...
    with tab_viz:
        ...
        if len(num_cols) >= 2:
            ...
            # Otomatis menyesuaikan ukuran biar tidak numpuk
            n = len(corr.columns)
    ...
    st.info("⬆️ Silakan unggah file CSV terlebih dahulu untuk memulai analisis.")
